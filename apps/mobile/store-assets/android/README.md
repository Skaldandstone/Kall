...
The same workflow captures an App Store-compliant iPhone set at 1284x2778 and
an iPad set at 2064x2752. Both store sets use the current public-registration
policy. Subscription review artwork is captured separately after native
purchases are enabled because it must show the real store-backed purchase
screen.
