...
// Required once at startup so the OAuth browser tab Clerk opens for Google/Apple
// sign-in closes itself and hands control back to the app after redirecting.
