...
export default function SettingsPage(){
  ...
  return <main className='shell'>
    ...
    <section className='grid' style={{gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))'}}>
      ...
      <a className='card' href='/settings/email'><h2>Email</h2><p>Connect Gmail or Outlook to auto-detect application status from confirmation, interview, and rejection emails.</p></a>
