  ...
  return (
    <main className="shell">
      <header className="topbar">
        ...
        <nav aria-label="Demo navigation" className="marketing-nav"><a href="/sign-in">Log in</a><a className="button" href="/sign-up">Sign up</a></nav>
      </header>
      ...
      <section className="card" style={{ marginTop: 32 }}>
        ...
        <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap', marginTop: 20 }}>
          <a className="button" href="/sign-up">Create your free account</a>
